...
class RegisterRoute extends MyURLSetter(PolymerElement) {
  static get template() {
    return html`
            ...
            <iron-form id="registration">
                <form>
                    <div class="form-inputs">
                        ...
                        <input id="firstname" name="firstname" type="text" class="text" required>
                        <small class="comment">Your real name, as found on your ID.</small>
                        <label>Family Name </label>
                        <input id="lastname" name="lastname" type="text" class="text" required>
                        <small class="comment">Your family name, as found on your ID.</small>
                        <label>Email Address</label>
                        <input id="email" name="email" type="text" class="text" required>
                    ...
                    <div class="footer">
                            <button on-click="_submitRegistration">Save Profile</button>
                    </div>
                </form>
            </iron-form>
        </div>
